  ...
  return (
    <section id="impact" aria-label={t("ariaLabel")} className="relative z-10 px-4 pb-10 sm:px-6 lg:px-8">
      <div className="mx-auto -mt-14 max-w-6xl sm:-mt-16">
        <ScrollRevealGroup className="grid grid-cols-2 gap-3 rounded-2xl border border-border bg-surface p-4 shadow-lg shadow-black/5 sm:grid-cols-4 sm:gap-4 sm:p-6 lg:p-8">
          {items.map((item) => (
            <ScrollRevealItem key={item.label}>
              <div className="flex flex-col items-center justify-center rounded-xl bg-surface-muted/60 px-3 py-4 text-center sm:px-4 sm:py-5">
